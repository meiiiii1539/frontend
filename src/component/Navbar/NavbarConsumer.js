...
const NavbarConsumer = () => {
    ...
    const link = ["/bags", "/brands", "/community", "/about"];
    const linkTag = ["包型分類", "品牌分類", "社群專欄", "關於我們"];
            ...
            <nav className='nav-up'>
                ...
                <div className='nav_group'>
                    ...
                    <div className="cartsidebar" style={{ width: cartsidebarWidth }}>
                        ...
                        <div className="shoppingcart" style={{ opacity: cartsidebarOpacity, transition: "all 0.5s" }}>
                            <Sidebar />
                        </div>
                    </div>
                </div>
